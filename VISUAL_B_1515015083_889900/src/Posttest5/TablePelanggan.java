...
if(Character.isDigit(b.getKeyChar())){
    ...
    private void initComponents() {
        ...
        kota.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Berau", "Sangatta", "Bontang", "Samarinda", " " }));
        ...
        jLabel5.setText("Copyright Pangestu Eko Laksono");
    ...
    private void namaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_namaCaretUpdate
        // TODO add your handling code here:
        if(nama.getText().length() !=0 && telepon.getText().length() !=0){
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        ...
        try{
            ...
            if (jRadioButton1.isSelected())
                     {jTable1.setValueAt(jRadioButton1.getText(), baris, 2);
                     }
            if (jRadioButton2.isSelected())
                     {jTable1.setValueAt(jRadioButton2.getText(), baris, 2);
                      }
        }
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        // TODO add your handling code here:
        try{
            int pilih = JOptionPane.showConfirmDialog(this, "Ingin hapus?", "Konfirmasi", JOptionPane.YES_OPTION);
